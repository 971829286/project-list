...
public class BillDownloadTest implements InitializingBean {

    private static final Logger log = LoggerFactory.getLogger(SettleTranResultConsumerTest.class);
