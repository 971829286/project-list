...
public class RSAUtil {
    ...
    public static String sign(String text, String privateKey, String charset) {
        try {
            ...
            logger.error("加签异常" + e.getStackTrace());
        }
        return null;
    }
    ...
    public static boolean verify(String text, String sign, String publicKey, String charset) {
        try {
            ...
            logger.error("验证签名异常" + e.getStackTrace());
        }
        return false;
    }
    ...
    public static byte[] decryptByPrivateKey(byte[] encryptedData, String privateKey)
        ...
        return getDealData(encryptedData, cipher, MAX_DECRYPT_BLOCK);
    }
    ...
    public static byte[] encryptByPublicKey(byte[] data, String publicKey) throws Exception {
        ...
        return getDealData(data, cipher, MAX_ENCRYPT_BLOCK);
    }
     ...
     * @throws IOException
     */
    private static byte[] getDealData(byte[] encryptedData, Cipher cipher, int block) throws IllegalBlockSizeException,
