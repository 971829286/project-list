...
public interface InvoiceContentMapper extends IBaseMapper<InvoiceContent> {
    @InsertProvider(type = InvoiceContentMapperProvider.class,method ="save")
    Integer save(InvoiceContent invoiceContent);

    @UpdateProvider(type = InvoiceContentMapperProvider.class,method = "update")
    Integer update(InvoiceContent invoiceContent);

    @SelectProvider(type = InvoiceContentMapperProvider.class,method = "selectById")
    @Results({
    ...
    @DeleteProvider(type = InvoiceContentMapperProvider.class,method = "deleteById")
    ...
    @SelectProvider(type=InvoiceContentMapperProvider.class,method = "selectByUserId")
    @Results({
            @Result(id = true,column = "id",property = "id"),
            @Result( column = "user_id",property = "userId"),
            @Result( column = "invoice_type",property = "invoiceType"),
