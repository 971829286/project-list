...
public interface InvoiceSiteMapper extends IBaseMapper<InvoiceSite> {
    @InsertProvider(type = InvoiceSiteMapperProvider.class,method ="save")
    Integer save(InvoiceSite invoiceSite);

    @UpdateProvider(type = InvoiceSiteMapperProvider.class,method = "update")
    Integer update(InvoiceSite invoiceSite);

    @SelectProvider(type = InvoiceSiteMapperProvider.class,method = "selectById")
    @Results({
    ...
    @DeleteProvider(type = InvoiceSiteMapperProvider.class,method = "deleteById")
    ...
    @SelectProvider(type = InvoiceSiteMapperProvider.class,method = "selectByUserId")
    @Results({
            @Result(id = true,column = "id",property = "id"),
            @Result( column = "user_id",property = "userId"),
            @Result( column = "receiver",property = "receiver"),
