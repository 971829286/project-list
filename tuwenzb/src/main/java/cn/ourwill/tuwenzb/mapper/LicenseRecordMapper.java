...
public interface LicenseRecordMapper extends IBaseMapper<LicenseRecord> {
    @InsertProvider(type = LicenseRecoreMapperProvider.class,method ="save")
    public Integer save(LicenseRecord licenseRecord);

    @UpdateProvider(type = LicenseRecoreMapperProvider.class,method = "update")
    public Integer update(LicenseRecord licenseRecord);

    @SelectProvider(type = LicenseRecoreMapperProvider.class,method = "findAll")
    @Results({
    ...
    @SelectProvider(type = LicenseRecoreMapperProvider.class,method = "selectById")
    @Results({
            @Result(id = true,column = "id",property = "id"),
            @Result( column = "user_id",property = "userId"),
            @Result( column = "license_type",property = "licenseType"),
    ...
    @DeleteProvider(type = LicenseRecoreMapperProvider.class,method = "deleteById")
    public Integer delete(Map param);

    @SelectProvider(type = LicenseRecoreMapperProvider.class,method = "selectByParam")
    @Results({
            @Result(id = true,column = "id",property = "id"),
            @Result( column = "user_id",property = "userId"),
            @Result( column = "license_type",property = "licenseType"),
