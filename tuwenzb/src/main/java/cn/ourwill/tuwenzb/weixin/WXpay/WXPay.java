...
import cn.ourwill.tuwenzb.weixin.WXpay.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public Map<String, String> getTransferInfo(Map<String, String> reqData) throws Exception {
        return this.getTransferInfo(reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
     ...
     * @throws Exception
     */
    public Map<String,String> getTransferInfo(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox){
            url = WXPayConstants.SANDBOX_GETTRANSFERINFO_URL;
        }else {
            url = WXPayConstants.GETTRANSFERINFO_URL;
        }
        String respXml = this.requestWithCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
