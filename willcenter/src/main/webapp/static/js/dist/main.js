...
var _jquery321Min = require('./lib/jquery-3.2.1.min.js');
...
function changeView(dom, className) {
  for (var i = 0; i < dom.length; i++) {
    (0, _jquery321Min2.default)(dom[i]).addClass('displayNone');
    if ((0, _jquery321Min2.default)(dom[i]).hasClass(className)) {
      (0, _jquery321Min2.default)(dom[i]).removeClass('displayNone');
    }
  }
}
...
function changeNav(nav, className) {
  for (var i = 0; i < nav.length; i++) {
    (0, _jquery321Min2.default)(nav[i]).removeClass('isChecked');
    (0, _jquery321Min2.default)(nav[i]).addClass('displayNone');
    if ((0, _jquery321Min2.default)(nav[i]).hasClass(className)) {
      (0, _jquery321Min2.default)(nav[i]).addClass('isChecked');
    }
  }
  if (className == 'login' || className == 'register') {
    (0, _jquery321Min2.default)(nav[0]).removeClass('displayNone');
    (0, _jquery321Min2.default)(nav[1]).removeClass('displayNone');
    (0, _jquery321Min2.default)(navIndex).removeClass('displayNone');
    (0, _jquery321Min2.default)(nav[5]).removeClass('displayNone');
    (0, _jquery321Min2.default)(nav[4]).removeClass('displayNone');
    if (className == 'register') {
      (0, _jquery321Min2.default)(navIndex).addClass('navIndexMove');
    } else {
      (0, _jquery321Min2.default)(navIndex).removeClass('navIndexMove');
    }
  } else if (className == 'resetPW') {
    (0, _jquery321Min2.default)(nav[2]).removeClass('displayNone');
    (0, _jquery321Min2.default)(navIndex).addClass('displayNone');
  } else if (className === 'nickName') {
    (0, _jquery321Min2.default)(nav[4]).removeClass('displayNone');
    (0, _jquery321Min2.default)(navIndex).addClass('displayNone');
  } else {
    (0, _jquery321Min2.default)(nav[3]).removeClass('displayNone');
    (0, _jquery321Min2.default)(navIndex).addClass('displayNone');
  }
}

_router2.default.route('/', function () {
  changeView(viewList, 'login');
  changeNav(navList, 'login');
});
_router2.default.route('/login', function () {
  // console.log("aaaaa了")
  changeView(viewList, 'login');
  changeNav(navList, 'login');
});
_router2.default.route('/nickName', function () {
  changeView(viewList, 'nickName');
  changeNav(navList, 'nickName');
});
_router2.default.route('/register', function () {
  changeView(viewList, 'register');
  changeNav(navList, 'register');
});
_router2.default.route('/resetPW', function () {
  // debugger;
  // console.log("我执行了")
  changeView(viewList, 'resetPW');
  changeNav(navList, 'resetPW');
});
_router2.default.route('/weixin', function () {
  changeView(viewList, 'weixin');
  changeNav(navList, 'weixin');
});

_router2.default.init();
},{"./lib/jquery-3.2.1.min.js":4,"./router.js":3}],11:[function(require,module,exports) {
