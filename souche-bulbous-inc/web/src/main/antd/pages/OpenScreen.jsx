...
class OpenScreen extends SADPage {
    ...
    addButton = () => {
        this.setState(() => ({
            ...
            protocol: '',
            targetUser: '',  //目标用户 多个之间用逗号隔开 为空表示所有用户
            startTime: moment().format(),   //时间精确到分钟
            ...
            <CMSHeader>
                ...
                <div>
                    <Modal
                        ...
                        title={this.state.operateType + '|APP开屏'}>
                        <Form>
                            <table>
                                <tbody>
                                {/* 标题行*/}
                                ...
                                <tr>
                                    ...
                                    <td style={{width: '79%'}}>
                                        <RangePicker
                                            value={[moment(this.state.startTime, 'YYYY-MM-DD HH:mm'), moment(this.state.endTime, 'YYYY-MM-DD HH:mm')]}
