...
public interface InvoiceRecordsMapper extends IBaseMapper<InvoiceRecords> {
    @InsertProvider(type = InvoiceRecordsSqlProvider.class,method ="save")
    Integer save(InvoiceRecords invoiceRecords);

    @UpdateProvider(type = InvoiceRecordsSqlProvider.class,method = "update")
    Integer update(InvoiceRecords invoiceRecords);

    @SelectProvider(type = InvoiceRecordsSqlProvider.class,method = "selectById")
    @Results({
    ...
    @DeleteProvider(type = InvoiceRecordsSqlProvider.class,method = "deleteById")
    Integer delete(Integer id);

    @SelectProvider(type = InvoiceRecordsSqlProvider.class,method = "selectByParams")
    @Results({
            @Result(id = true,column = "id",property = "id"),
            @Result( column = "apply_time",property = "applyTime"),
            @Result( column = "order_nos",property = "orderNos"),
