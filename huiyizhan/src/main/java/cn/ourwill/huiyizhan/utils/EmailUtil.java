...
public class EmailUtil {
     ...
     * @return
     */
    public static Properties SMTP(boolean debug){
        Properties props = defaultConfig(debug);
        props.put("mail.smtp.host","smtp.ourwill.com.cn");
     ...
     */
    public static EmailUtil subject(String subject){
    ...
    public EmailUtil from(String nickName){
        return from(nickName, user);
    }
    public EmailUtil from(String nickName,String from){
        try {
    ...
    public EmailUtil replyTo(String... replyTo){
        String result = Arrays.asList(replyTo).toString()
                .replaceAll("(^\\[|\\]$)", "")
                .replace(", ", ",");
        try {
    ...
    private EmailUtil addRecipients(String[] recipients, Message.RecipientType type) throws MessagingException {
        String result = Arrays.asList(recipients).toString()
                .replace("(^\\[|\\]$)", "")
                .replace(", ", ",");
