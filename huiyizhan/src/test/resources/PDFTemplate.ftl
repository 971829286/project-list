...
<div class="mainBg">
  <#list ticketsRecords as ticketsRecord>
    <img width="600" height="257" src="img/ticket_bg.png">
  </#list>
</div>
<#list ticketsRecords as ticketsRecord>
    ...
    <div class="mainContent">
        ...
        <div class="mainInRight">
            <div class="layoutLeft">
                <h1 class="title">${ticketsRecord.activity.activityTitle}</h1>
                <div class="ticketMsg">
                    <div class="msgItem msgItem_1">
                        <p class="title">开始时间</p>
                        <p class="text">${ticketsRecord.activity.startTime?string('yyyy-MM-dd HH:mm:ss')}</p>
                    </div>
                    <div class="msgItem msgItem_2">
                        <p class="title">活动地址</p>
                        <p class="text">${ticketsRecord.activity.activityAddress}</p>
                    </div>
            ...
            <div class="layoutRight">
                <div class="QRCode">
                    <img width="120" height="120" src="${ticketsRecord}"/>
                </div>
                <div class="code">${ticketsRecord.signCode}</div>
            </div>
        </div>
    </div>
</div>
