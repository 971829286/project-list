...
public class OrderCenterSPITest extends BaseTest {
    ...
    public void createOrder2Test(){
        MaintenanceRecordDO operateCouponQO = new MaintenanceRecordDO();
    ...
    public void finishCoupon(){
        MaintenanceRecordDO carMaintenance = maintenanceRecordManager.getCarMaintenance("881599150521");
        String s = orderCenterSPI.finishCoupon(carMaintenance);
    }
    //释放卷测试
    @Test
    public void realeaseCoupon(){
        MaintenanceRecordDO carMaintenance = maintenanceRecordManager.getCarMaintenance("884515839020");
        String s = orderCenterSPI.realeaseCoupon(carMaintenance);
    }
